...
export function StokDuzeltme({ productId, mevcutStok, yetkili }: Props) {
  ...
  async function kaydet() {
    ...
    const { error } = await supabase.rpc("stok_hareketi_ekle", {
    ...
    if (error) {
      setHata("Düzeltme kaydedilemedi.");
      return;
    }
  ...
  return (
    <div className="glass w-full max-w-xs rounded-xl p-4 sm:absolute sm:right-0 sm:top-11 sm:z-30 sm:shadow-xl">
